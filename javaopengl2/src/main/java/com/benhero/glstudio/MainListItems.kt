...
object MainListItems {
    ...
    init {
        ...
        addItem(Item(L1_1_PointRenderer_2::class.java, "L1_1_基础框架_2"))
        ...
        addItem(Item(L6_2_1TextureRenderer::class.java, "L6_2_1多纹理渲染:单个纹理单元"))
        addItem(Item(L6_2_2TextureRenderer::class.java, "L6_2_2多纹理渲染:多个纹理单元"))
        ...
        addItem(Item(L8_2_GrayFilterRenderer::class.java, "L8_2_灰色滤镜渲染"))
