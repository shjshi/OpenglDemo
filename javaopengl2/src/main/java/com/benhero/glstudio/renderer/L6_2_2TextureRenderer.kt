...
//        )
        ...
        // 可以改变杰尼龟的大小
        private val xxx_VERTEX_DATA = floatArrayOf(
            -0.2f, -0.2f,
            -0.2f, 0.2f,
            0.2f, 0.2f,
            0.2f, -0.2f
    ...
    init {
        ...
        val vertexToTexture = vertexToTexture(xxx_VERTEX_DATA)
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        GLES20.glDrawArrays(GLES20.GL_TRIANGLE_FAN, 0, xxx_VERTEX_DATA.size / POSITION_COMPONENT_COUNT)
    }
